...
@Component({
	selector: 'app-text-counter-text-mode',
	standalone: true,
	templateUrl: './text-counter-text-mode.component.html',
	styleUrls: ['./text-counter-text-mode.component.scss'],
...
export class TextCounterTextModeComponent implements OnInit {
